...
public class BirthdayDto extends EventDto {
    ...
    public BirthdayDto (Integer id, String name, List<RoomUse> roomUses, LocalDateTime created, LocalDateTime updated, Integer headCount, Customer guardian, Integer avgAge, TrainerDto trainerDto, BirthdayType type) {

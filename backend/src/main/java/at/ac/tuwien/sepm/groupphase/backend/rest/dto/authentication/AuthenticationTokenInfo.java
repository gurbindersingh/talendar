...
@ApiModel(value = "AuthenticationTokenInfo",
...
public class AuthenticationTokenInfo {
    ...
    public boolean equals(Object o) {
        ...
        if(validityDuration != null
           ? !validityDuration.equals(that.validityDuration)
           : that.validityDuration != null)
            return false;
        return overlapDuration != null
               ? overlapDuration.equals(that.overlapDuration)

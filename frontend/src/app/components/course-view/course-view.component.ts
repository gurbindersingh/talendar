...
export class CourseViewComponent implements OnInit {
  ...
  constructor(private eventClient: EventClient, private modalService: NgbModal) { 
  }
  
  private popup: NgbdModalConfirm;
